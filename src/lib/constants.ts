...
export const SECTIONS: SectionDef[] = [
  ...
  {
    id: "legal-workspace",
    label: "مساحة العمل القانونية",
    icon: Briefcase,
    group: "main",
    description: "مساحة عمل موحدة لكل قضية بتبويبات ذكية",
  },
  {
    id: "template-studio",
    ...
    icon: PenLine,
    group: "ai",
    description: "مصمم قوالب قانونية مرئي مع متغيرات ديناميكية",
  },
  {
    ...
    icon: Gavel,
    group: "system",
    description: "مصمم سير عمل مرئي لأنواع القضايا",
  },
  {
    ...
    icon: RefreshCw,
    group: "system",
    description: "منشئ قواعد الأتمتة المرئي",
  },
  {
    id: "reporting-bi",
    ...
    icon: BarChart3,
    group: "analytics",
    description: "منصة تحليلات مؤسسية ومنشئ تقارير",
  },
  {
    id: "integration-hub",
    ...
    icon: ShieldCheck,
    group: "system",
    description: "إدارة جميع التكاملات والوصلات",
  },
  {
    id: "digital-twin",
    label: "النموذج الرقمي للمكتب",
    icon: TrendingUp,
    group: "analytics",
    description: "نموذج رقمي للمكتب وتوزيع الأحمال",
  },
  {
    id: "tasks",
    label: "المهام",
